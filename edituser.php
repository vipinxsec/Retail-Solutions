  ...
  color: #68dff0 !important;
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <div class="row mt">
            <div class="col-lg-12">
            <div align="center" style="max-height: 465px; overflow: auto;">
              <!-- BASIC BUTTONS -->
...
<table border="1" class="table table-bordered table-striped table-condensed" style="width: 100%; font-size: 90%;">
      <thead style="color:#063770; background-color:#96B1D0;">
        <tr>
        <th><center></center>S.no</th>
        <th> </th>
          <th><center>Name</center></th>
          <th><center>Designation</center></th>
          <th><center>Department</center></th>
          <th><center>Status</center></th>
          <th><center>Reporting Person</center></th>
...
while($result = mysql_fetch_assoc($query)){
                ...
                echo'<td><b><a href="edituserinfo.php?id='.$result['id'].'">Edit</a></b></td>';
                echo'<td width="120px"> ' . $result['name'] . '</td> ';
                echo'<td width="90px"> ' . $result['designation'] . '</td> ';
                echo'<td> ' . $result['department'] . '</td> ';
                echo'<td> ' . $result['user_status'] . '</td> ';
                echo'<td> ' . $result['report_person'] . '</td> ';
                echo'<td width="90px"> ' . $result['username'] . '</td> ';
      ...
      <footer class="navbar-fixed-bottom site-footer">
          <div class="text-center">
              ...
              <a href="edituser.php#" class="go-top">
