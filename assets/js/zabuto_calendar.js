...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function drawCalendar() {
            ...
            var $contboxHtml = $('<div class="zabuto_calendar" id="' + $calendarElement.attr('id') + '"></div>');
            $contboxHtml.append($tableObj);
            $contboxHtml.append($legendObj);

            $calendarElement.append($contboxHtml);
        }
