...
// Pendo Track Event: masterdata_exported
...
$_pendo_data = json_encode(array("type" => "track", "event" => "masterdata_exported", "visitorId" => $_pendo_visitor, "accountId" => "retail_solutions", "timestamp" => round(microtime(true) * 1000), "properties" => $_pendo_props));
