...
a.msg:hover{
  ...
  <li><a data-toggle="tab" href="#vidbox">Upload Video</a></li>
</ul>
...
.nav-tabs, .nav-pills {
    text-align:center;
                    ...
                    <div class="tab-content">
                      ...
                      <input type="file" name="vidfile"><br>
                      <input type="submit" class="btn btn-info" value="Upload file" name="uploadppt" multiple="">
                      </form>
...
{
$errors= array();
$extensions= array(".ppt", ".pptx", ".xls", ".xlsx", ".doc", ".docx");
$file_name = $_FILES['pptfile']['name'];
$file_ext=substr($file_name, strrpos($file_name, '.'));
$info = pathinfo($_FILES['pptfile']['name']);
$target = 'uploads/infohub/doc/'.$file_name;
...
echo 'alert("Please Upload only .ppt files.")';
echo '</script>';
      }
...
$target = 'uploads/infohub/video/'.$file_name;
